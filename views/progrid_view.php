...
require_once("../controllers/progrid_controller.php");
...
<!--	Title
	=========================================================-->
<title>Homex - Real Estate Website</title>
</head>
<body>
    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('../images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Danh sách Bất động sản</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-primary mb-2 text-capitalize"><a href="../controllers/prodetail_controller.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                        ...
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            ...
                                            <div class="float-right"><i class="far fa-calendar-alt text-primary mr-1"></i> <?php echo $row['29']   ?> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Tính toán trả góp</h4>
						<form class="d-inline-block w-100" action="../controllers/calc_controller.php" method="post">
                            ...
                            <button type="submit" value="submit" name="calc" class="btn btn-primary mt-4">Tính toán</button>
                        </form>
                        </div>
                        
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Bất động sản được thêm gần đây</h4>
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="../admin/property/<?php echo $row['18'];?>" alt="pimage">
                                    <h6 class="text-secondary hover-text-primary text-capitalize"><a href="../controllers/prodetail_controller.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
