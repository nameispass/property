<?php
include_once "../controllers/feature_controller.php";
?>
					...
					<table class="items-list col-lg-12" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="../controllers/submitpropertyup_controller.php?id=<?php echo $row['0'];?>">Update</a></td>
								<td><a class="btn btn-primary" href="../controllers/submitpropertydelete.php?id=<?php echo $row['0'];?>">Delete</a></td>
                            </tr>
							<?php } ?>
